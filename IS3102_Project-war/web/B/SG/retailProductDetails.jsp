...
<html> <!--<![endif]-->
    ...
    <body>
        <%
            ...
            for(RetailProduct i : retailProducts){
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div>
                                    <div class="thumbnail">
                                        <img alt="" class="img-responsive img-rounded" src="../../..<%=RP.getImageUrl()%>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="summary entry-summary">
                                    <h2 class="shorter"><strong> <%=RP.getName()%></strong></h2>

                                    <p class="price"><h4 class="amount">$<%=RP.getPrice()%>0</h4></p>
                                    <strong>Description</strong>
                                    <p class="taller">
                                        <%=RP.getDescription()%>
                                    </p>
                                    <div class="product_meta">
                                        <span class="posted_in">Category: <a rel="tag" href="#"><%=RP.getCategory()%></a></span>
                                    </div>
                                    <br/><br/>
