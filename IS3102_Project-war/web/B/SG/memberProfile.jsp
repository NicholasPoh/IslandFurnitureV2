                        ...
                        <div class="tabs">
                                ...
                                <div id="overview" class="tab-pane active">
                                    ...
                                    <form role="form" action="../../ECommerce_MemberEditProfileServlet" onsubmit="return validatePassword()">
                                        ...
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" required="true" name="name" type="text" value="<%=session.getAttribute("memberName")%>">
                                        </div>
                                        <div class="form-group">
                                            <label>E-mail Address</label>
                                            <input class="form-control" required="true" value="<%=session.getAttribute("memberEmail")%>" disabled/>
                                        </div>
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input class="form-control" required="true" type="text" name="phone" value="<%=session.getAttribute("memberPhone")%>">
                                        </div>
                                        <div class="form-group">
                                            <label>Country</label>
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input class="form-control" type="text" required="true" name="address" value="<%=session.getAttribute("memberAddress")%>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Age</label>
                                            <input class="form-control" name="age" step="1" type="number" min="1" max="150" value="<%=session.getAttribute("memberAge")%>">
                                        </div>
                                        <div class="form-group">
                                            <label>Income per annum (in USD)</label>
                                            <input class="form-control" name="income" step="1" type="number" min="0" max="2147483646" value="<%=session.getAttribute("memberIncome")%>">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="tab-content">
                                <div id="loyaltyProgram" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                        <label>Plans for thy system's creation is ambiguous... It's quite loyal of you 
                                        to check out this page anyways. :3</label>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-content">
                                <div id="salesHistory" class="tab-pane active">
                                    <h4>Sales History</h4>
                                    <table>
                                        <thead></thead>
                                        <tbody>
                                        <%if(session.getAttribute("historySales") == null){%>
                                        </tbody>
                                    </table>
                                            <%}
                                            else{
                                                ArrayList<ArrayList<ShoppingCartLineItem>> historySales = 
                                                    (ArrayList<ArrayList<ShoppingCartLineItem>>) session.getAttribute("historySales");
                                                try{
                                                    for(ArrayList<ShoppingCartLineItem> historyCart: historySales){%>
                                                        <tr>
                                                            <td>
                                                                <table cellspacing="0" class="shop_table cart">
                                                                    ...
                                                                    <tbody>
                                                                    <%for (ShoppingCartLineItem item : historyCart){%>
                                                                        <tr class="cart_table_item">
                                                                            ...
                                                                            <td class="product-name">
                                                                                <a class="productDetails" href="furnitureProductDetails.jsp"><%=item.getSKU()%></a>
                                                                            </td>
                                                                            ...
                                                                            <td class="product-quantity">
                                                                                <span class="amount" id="totalPrice<%=item.getQuantity()%>">
                                                                                </span>
                                                                            </td>
