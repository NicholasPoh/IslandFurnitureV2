...
public class CountryItemPricingManagement_UpdateCountryItemPricingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        NumberFormat decimal = new DecimalFormat("0.#");
        try {
            ...
            ReturnHelper helper = itemManagementBean.editCountryItemPricing(Long.parseLong(id), Double.parseDouble(decimal.format(Double.parseDouble(price))));
